...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
            ...
            .antMatchers(HttpMethod.GET, "/flights").hasAnyAuthority("AGENT", "USER")
            .antMatchers(HttpMethod.PUT, "/flights").hasAnyAuthority("AGENT")
            .antMatchers(HttpMethod.GET, "/airplanes").authenticated()
            .antMatchers(HttpMethod.GET, "/airports").authenticated()
            .antMatchers(HttpMethod.GET, "/routes").authenticated();
    }
